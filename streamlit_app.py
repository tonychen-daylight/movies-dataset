...
min_distance = container1.number_input('Min Distance (miles)', min_value=0, value=2000, key='min_distance')
max_distance = container1.number_input('Max Distance (miles)', min_value=0, value=58000, key='max_distance')
#min_savings = container1.number_input('Min Savings($)', min_value=0, value=-100, key='min_savings')
max_distance7 = container1.number_input('Max Distance7 (miles)', min_value=0, value=58000, key='max_distance7')
max_idle_time = container1.number_input('Max Idle Time (days)', min_value=0, value=1.1, key='max_idle_time')
